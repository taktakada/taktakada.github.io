...
$site_top = "http://hosho.ees.hokudai.ac.jp/~takada/contact/thanks.html";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "takada@ees.hokudai.ac.jp,fujino@cobitospice.com";
...
$thanksPage = "http://hosho.ees.hokudai.ac.jp/~takada/contact/thanks.html";
...
北海道大学大学院環境科学院
高田壮則
URL: http://hosho.ees.hokudai.ac.jp/~takada/
──────────────────────
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	$adminBody="お問い合わせフォームからメールが届きました\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
